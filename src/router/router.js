...
import HoneyChainSiteManage from '@/views/honeyChain/siteManage'; // 蜜链站点管理
import HoneyChainHitAnalysis from '@/views/honeyChain/hitAnalysis'; // 蜜链命中分析
import HoneyChainDetail from '@/views/honeyChain/chainDetail'; // 蜜链详情
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'HoneyChain',
          component: SubLayout,
          redirect: '/honey-chain/site-manage',
          meta: { title: '蜜链管理' },
          children: [
            {
              path: 'site-manage',
              name: 'HoneyChainSiteManage',
              meta: { title: '站点管理' },
              component: HoneyChainSiteManage
            },
            {
              path: 'hit-analysis',
              name: 'HoneyChainHitAnalysis',
              meta: { title: '命中分析' },
              component: HoneyChainHitAnalysis
            },
            {
              path: 'chain-detail',
              name: 'HoneyChainDetail',
              meta: { title: '蜜链详情' },
              component: HoneyChainDetail
            },
          ]
        },
      ]
